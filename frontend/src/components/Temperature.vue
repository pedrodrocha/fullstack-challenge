<template>
  <div class="flex flex-col w-full h-full">
    <div class="flex flex-col items-center gap-2 mb-8">
      ...
      <div v-if="!weather" class="bg-slate-400 h-10 w-24 animate-pulse"></div>
    ...
    <div class="flex flex-row flex-nowrap justify-between w-full px-2 mb-4">
      ...
      >
        ...
        <p class="text-sky-900 font-bold text-sm">Refresh</p>
      </button>

      <button
        v-if="weather"
        type="button"
        @click="$emit('openDetails', weather)"
      >
        <p class="text-sky-900 font-bold text-sm">More Details</p>
      </button>
    ...
    <div>
      <div v-if="!weather" class="bg-slate-400 h-3 w-24 animate-pulse"></div>

      <p
        v-if="weather"
        class="font-serif font-light text-slate-400 text-xs self-start justify-self-start"
      >
